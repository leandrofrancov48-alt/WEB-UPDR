...
export const MASTER_BANDS_POOL: BandOption[] = [
  ...
  // --- TIER ARTISTAS EMERGENTES UPDR (OVR 40 - 45 / EDAD 16) ---
  {
    ...
    bonusTalent: 3,
    bonusCharisma: 3,
    description: 'Banda emergente de barrio postulada en UPDR. Ensayos en el garage y bailes comunitarios.',
  ...
  },
  {
    ...
    bonusTalent: 4,
    bonusCharisma: 2,
    description: 'Banda emergente con acordeón norteño y ritmo pegadizo votada por la comunidad UPDR.',
  ...
  },
  {
    ...
    bonusTalent: 2,
    bonusCharisma: 4,
    description: 'Proyecto emergente cordobés de tutti, piano y alegría popular en clubes de barrio.',
  ...
  {
    id: 'cumbia_y_barrio_emergente',
    name: 'Cumbia & Barrio',
    logo: '🏆',
    category: '⭐ ARTISTA EMERGENTE UPDR (Top #1 Votos)',
    actionLabel: 'Sumarte al furor emergente de',
    requiredOvr: 40,
    baseSuccessRate: 100,
    bonusTalent: 3,
    bonusCharisma: 4,
    description: 'Banda emergente #1 en likes de la web de UPDR. Sonido de barrio auténtico y alegre.',
    positiveText: '¡OVACIÓN EN EL BAILARÍN DE BARRIO! Los fans de la web fueron a hacerte el aguante en vivo.',
    negativeText: '¡Sin fallos! Noche de fiesta total con el público emergente.',
  },
  {
    id: 'sonido_callejero_emergente',
    name: 'Sonido Callejero',
    logo: '🥁',
    category: '⭐ ARTISTA EMERGENTE UPDR (Top #2 Votos)',
    actionLabel: 'Fichar en la banda emergente',
    requiredOvr: 40,
    baseSuccessRate: 100,
    bonusTalent: 4,
    bonusCharisma: 3,
    description: 'Grupo emergente de cumbia villera elegido entre los más votados en Un Poco de Ruido.',
    positiveText: '¡PUNTOS Y APLAUSOS! El repique callejero hizo temblar la pista de baile.',
    negativeText: '¡Sin fallos! Presentación impecable en el circuito emergente.',
  },
  {
    id: 'los_herederos_ritmo',
    name: 'Los Herederos del Ritmo',
    logo: '🪗',
    category: '⭐ ARTISTA EMERGENTE UPDR (Top #3 Votos)',
    actionLabel: 'Hacer vibrar el acordeón con',
    requiredOvr: 40,
    baseSuccessRate: 100,
    bonusTalent: 4,
    bonusCharisma: 3,
    description: 'Jóvenes talentos emergentes santafesinos destacados por la comunidad de 1PDR.',
    positiveText: '¡MAESTRÍA DE BARRIO! Arreglos cumbieros celebrados por todos los presentes.',
    negativeText: '¡Sin fallos! Show impecable de principio a fin.',
  },
  {
    id: 'la_nueva_cumbia_zs',
    name: 'La Nueva Cumbia ZS',
    logo: '🌴',
    category: '⭐ ARTISTA EMERGENTE UPDR',
    actionLabel: 'Representar Zona Sur en',
    requiredOvr: 40,
    baseSuccessRate: 100,
    bonusTalent: 3,
    bonusCharisma: 3,
    description: 'Proyecto tropical de Zona Sur postulado a los especiales de emergentes de UPDR.',
    positiveText: '¡FIESTA EN EL SUR! El boliche repleto de pibes bailando el ritmo de Zona Sur.',
    negativeText: '¡Sin fallos! Gran recibimiento del público.',
  },
  {
    id: 'alto_impacto_cumbia',
    name: 'Alto Impacto Tropical',
    logo: '🎺',
    category: '⭐ ARTISTA EMERGENTE UPDR',
    actionLabel: 'Hacer sonar los vientos con',
    requiredOvr: 42,
    baseSuccessRate: 100,
    bonusTalent: 4,
    bonusCharisma: 3,
    description: 'Banda emergente santafesina con sección de vientos y percusión potente.',
    positiveText: '¡POTENCIA TROPICAL! Los caños de bronce sonaron afinados e hicieron bailar a todos.',
    negativeText: '¡Sin fallos! Gran debut de orquesta emergente.',
  },
  {
    id: 'los_guaracheros_santiago',
    name: 'Guaracheros de Santiago',
    logo: '💃',
    category: '⭐ ARTISTA EMERGENTE UPDR',
    actionLabel: 'Meter velocidad y repique en',
    requiredOvr: 42,
    baseSuccessRate: 100,
    bonusTalent: 3,
    bonusCharisma: 4,
    description: 'Grupo emergente de guaracha santiagueña acelerada postulados en Un Poco de Ruido.',
    positiveText: '¡FIESTA GUARACHERA! El público bailó zapateando sin parar durante todo el enganchado.',
    negativeText: '¡Sin fallos! La pista ardió a pura guaracha.',
  },
  {
    id: 'banda_estilo_1pdr',
    name: 'Banda Estilo 1PDR',
    logo: '🎤',
    category: '⭐ ARTISTA EMERGENTE UPDR',
    ...
    bonusTalent: 3,
    bonusCharisma: 4,
    description: 'Banda emergente nacida de la comunidad de oyentes y músicos de Un Poco de Ruido.',
    positiveText: '¡CONAGRACIÓN COMUNITARIA! Los oyentes de UPDR reconocieron al instante el talento.',
    negativeText: '¡Sin fallos! Gran zapada inaugural.',
  },
  {
