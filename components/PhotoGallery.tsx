    ...
    async function fetchPhotos() {
      try {
        ...
        if (Array.isArray(data)) {
          ...
          // ELIMINÉ EL CÓDIGO QUE ABRÍA LA PRIMERA CARPETA AUTOMÁTICAMENTE
        }
      } catch (error) {
        ...
        >
          ...
          >
            ...
            <a 
              ...
              download 
              className="mt-4 bg-brand-yellow text-black font-bold py-3 px-8 rounded-full hover:bg-white transition-all duration-300 flex items-center gap-2 shadow-[0_0_20px_rgba(232,212,63,0.4)]"
            >
