    ...
    return L.divIcon({
      html: `
        <div class="relative w-12 h-14 group flex flex-col items-center">
          ...
          <!-- Pin tail -->
          <div class="w-0 h-0 border-l-[6px] border-r-[6px] border-t-[8px] border-l-transparent border-r-transparent relative -top-1 z-0 transition-transform duration-300 group-hover:translate-y-1" style="border-top-color: ${borderColor}"></div>
        </div>
      `,
